package uz.abbosbek.musicplayerjava;
...
public class PlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFastForward = findViewById(R.id.btn_FastForward);
        btnFastBackward = findViewById(R.id.btn_FastBackward);
        ...
        btnPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mediaPlayer.isPlaying()) {
                    ...
                    mediaPlayer.start();
                    //todo: Music player ni image uchun animatsiya
        ...
        // todo: btnNext bosilganda keyingi musiqaga o'tadi va musiqani nomi ham o'zgaradi va animatsiyani ishlatadi
        ...
        // todo: btnNext bosilganda oldingi musiqaga o'tadi va musiqani nomi ham o'zgaradi va animatsiyani ishlatadi
    ...
    // todo: seekBar ni time uchun hisoblanyabti musiqa time hisoblash uchun
